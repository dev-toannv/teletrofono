...
--
-- Host: localhost
-- Generation Time: Jan 04, 2021 at 03:17 PM
...
(78, '', '123', '', NULL, NULL, NULL, NULL, NULL, NULL, 3),
(139, 'vantoan', 'vantoan', 'vantoan', NULL, NULL, NULL, NULL, NULL, NULL, 3),
(140, 'vantoan1', 'vantoan1', 'toilanguyenvantoandayaaaalllllllllllllll', NULL, NULL, NULL, NULL, NULL, NULL, 3);
...
INSERT INTO `cus_type` (`id`, `cus_id`, `cus_type`) VALUES
(1, 143, 3);
...
--
-- Table structure for table `product_one_bill`
--

CREATE TABLE `product_one_bill` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `product_one_bill`
--
ALTER TABLE `product_one_bill`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `product_one_bill`
--
ALTER TABLE `product_one_bill`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bill`
  ADD CONSTRAINT `bill_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `cart` (`cart_idcustomer`),
  ADD CONSTRAINT `bill_ibfk_2` FOREIGN KEY (`bill_phonenumber`) REFERENCES `phone` (`id`);
...
--
-- Constraints for table `product_one_bill`
--
ALTER TABLE `product_one_bill`
  ADD CONSTRAINT `product_one_bill_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`),
  ADD CONSTRAINT `product_one_bill_ibfk_2` FOREIGN KEY (`id_bill`) REFERENCES `bill` (`id`);
